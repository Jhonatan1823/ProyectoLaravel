      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav">
            <a href="{{ route('welcome') }}" class="navbar-brand" style="text-decoration:none;color: white;"><h1>Celuaccel</h1></a>
                ...
                @foreach ($datos as $item)
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="{{ route('mensajes.porChat', $item->Codigo_Chat) }}" class="btn btn-info btn-sm">Mensaje</a>

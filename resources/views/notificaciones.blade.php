            ...
            <div class="card-body" style="width: 1200px;">
                ...
                <form action="{{ route('notificaciones.index') }}" method="GET">
                    <div class="text-end mb-3">
                        @if($rol == 1 or $rol == 3)<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#AgregarModal" style="background-color:red;"><i class="fa-solid fa-bell-circle-plus"></i> Nueva Notificación</button>@endif
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        @if($rol == 1 or $rol == 3)<td>
                                            ...
                                            <form action="{{ route('notificaciones.destroy', $item->Codigo_Notificaciones) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" style="background-color:black;color:white;" class="btn btn-danger btn-sm" onclick="return confirm('¿Estás seguro de eliminar el tipo de notificación: {{ $item->Tipo_Notificacion }}?')">

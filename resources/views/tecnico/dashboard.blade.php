...
<body>
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav>
                <ul class="nav-menu">
                    <!-- DASHBOARD -->
                    <li class="nav-item">
                        <a href="/tecnico" class="nav-link active">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="submenu" id="serviciosSubmenu">
                            <li class="submenu-item">
                                <a href="{{ route('servicio.index') }}" class="submenu-link">
                                    <span>Ver Asignados</span>
                                </a>
                            </li>
                            <li class="submenu-item">
                                <a href="/tecnico/servicios-asignados" class="submenu-link">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="submenu" id="chatSubmenu">
                            <li class="submenu-item">
                                <a href="{{ route('chat.index') }}" class="submenu-link">
                                    <span>Chats Activos</span>
                                </a>
                            </li>
                            <li class="submenu-item">
                                <a href="{{ route('mensajes.index') }}" class="submenu-link">
                                    <span>Mensajes</span>
                                </a>
                            </li>
                        </ul>
                    ...
                    <!-- HISTORIAL -->
                    <li class="nav-item">
                        <a href="#historialSubmenu" class="nav-link" id="historialToggle">
                        ...
                        <ul class="submenu" id="historialSubmenu">
                            <li class="submenu-item">
                                <a href="{{ route('historial.index') }}" class="submenu-link">
                                    <span>Mis Reparaciones</span>
                                </a>
                            </li>
                            <li class="submenu-item">
                                <a href="/tecnico/mi-historial" class="submenu-link">
                                    <span>Reportes</span>
                                </a>
                            </li>
                        </ul>
                    ...
                    <!-- REPORTES -->
                    <li class="nav-item">
                        <a href="/tecnico/estadisticas" class="nav-link">
        ...
        <main class="main-content">
            ...
            <div style="background: #f9f9f9; padding: 25px; border-radius: 12px; margin-bottom: 30px;">
                ...
                <p style="color: #666; font-size: 1.1rem;">
                    Has iniciado sesión como <strong>Técnico</strong> | 
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-label">Servicios terminados</div>
                </div>
            ...
            <div class="modules-grid">
                <div class="module-card">
                    ...
                    <h3 class="module-title">Servicios Asignados</h3>
                    <p class="module-desc">Gestiona las reparaciones que tienes asignadas. Actualiza estados y tiempos.</p>
                    <a href="{{ route('servicio.index') }}" class="module-btn">Ver Servicios</a>
                </div>
                
                <div class="module-card">
                    <div class="module-icon"><i class="fas fa-comments"></i></div>
                    <h3 class="module-title">Chat con Clientes</h3>
                    <p class="module-desc">Atiende consultas y brinda soporte técnico a los clientes.</p>
                    <a href="{{ route('chat.index') }}" class="module-btn">Ir al Chat</a>
                </div>
                
                <div class="module-card">
                    <div class="module-icon"><i class="fas fa-history"></i></div>
                    <h3 class="module-title">Mi Historial</h3>
                    <p class="module-desc">Consulta el historial de todas tus reparaciones realizadas.</p>
                    <a href="{{ route('historial.index') }}" class="module-btn">Ver Historial</a>
                </div>
                
                <div class="module-card">
                    <div class="module-icon"><i class="fas fa-chart-bar"></i></div>
                    <h3 class="module-title">Reportes</h3>
                    <p class="module-desc">Genera reportes de productividad y eficiencia en reparaciones.</p>
                    <a href="/tecnico/estadisticas" class="module-btn">Ver Reportes</a>
                </div>
                
                <div class="module-card">
                    <div class="module-icon"><i class="fas fa-clipboard-check"></i></div>
                    <h3 class="module-title">Checklist Diario</h3>
                    <p class="module-desc">Revisa y completa tu checklist de actividades diarias.</p>
                    <a href="/tecnico/checklist" class="module-btn">Ver Checklist</a>
                </div>
                
                <div class="module-card">
                    <div class="module-icon"><i class="fas fa-user-cog"></i></div>
                    <h3 class="module-title">Mi Perfil</h3>
                    <p class="module-desc">Actualiza tu información personal y preferencias de trabajo.</p>
                    <a href="/profile" class="module-btn">Editar Perfil</a>
                </div>
            </div>
            
            <!-- SERVICIOS PENDIENTES -->
            <div style="background: white; padding: 25px; border-radius: 12px; margin-top: 30px; box-shadow: 0 5px 15px rgba(0,0,0,0.08);">
                <h3 style="color: var(--secondary-color); margin-bottom: 20px; display: flex; align-items: center; gap: 10px;">
                    <i class="fas fa-clock" style="color: var(--primary-color);"></i>
                    Servicios Pendientes (Urgentes)
                </h3>
                
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
                    <div style="background: #fff8e6; padding: 20px; border-radius: 8px; border-left: 4px solid #ff9800;">
                        <h4 style="color: #333; margin-bottom: 10px;">Servicio #00123</h4>
                        <p style="color: #666; margin-bottom: 8px;"><strong>Cliente:</strong> Juan Pérez</p>
                        <p style="color: #666; margin-bottom: 8px;"><strong>Dispositivo:</strong> iPhone 12</p>
                        <p style="color: #666; margin-bottom: 8px;"><strong>Estado:</strong> En diagnóstico</p>
                        <a href="{{ route('servicio.index') }}" style="color: var(--primary-color); text-decoration: none; font-weight: bold;">
                            Ver detalles →
                        </a>
                    </div>
                    
                    <div style="background: #ffe6e6; padding: 20px; border-radius: 8px; border-left: 4px solid #d20000;">
                        <h4 style="color: #333; margin-bottom: 10px;">Servicio #00124</h4>
                        <p style="color: #666; margin-bottom: 8px;"><strong>Cliente:</strong> María López</p>
                        <p style="color: #666; margin-bottom: 8px;"><strong>Dispositivo:</strong> Samsung S21</p>
                        <p style="color: #666; margin-bottom: 8px;"><strong>Estado:</strong> Esperando repuesto</p>
                        <a href="{{ route('servicio.index') }}" style="color: var(--primary-color); text-decoration: none; font-weight: bold;">
                            Ver detalles →
                        </a>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const historialSubmenu = document.getElementById('historialSubmenu');
            ...
            historialToggle.addEventListener('click', function(e) {
                e.preventDefault();
                historialSubmenu.classList.toggle('active');
                this.querySelector('.nav-arrow').textContent = 
                    historialSubmenu.classList.contains('active') ? '▲' : '▼';
            });

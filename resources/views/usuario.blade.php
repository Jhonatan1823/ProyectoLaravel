            ...
            <div class="card-body">
                ...
                <form name="usuario" action="{{ url('/usuario') }}" method="GET">
                    <div class="text-end mb-3">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#AgregarModal" style="background-color:red;"><i class="fa-solid fa-plus"></i> Nuevo</button>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('usuario.destroy', $item->ID_Usuario) }}" method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" style="background-color:black;color:white;" class="btn btn-danger" onclick="return confirm('¿Estás seguro de eliminar este usuario?')">

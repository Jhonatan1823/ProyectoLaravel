...
<body>
    <!-- Navbar -->
    <nav class="navbar">
        <a href="#" class="navbar-brand">Celuaccel</a>
        <div class="nav-links">
    ...
    <section class="hero" id="inicio">
        ...
        <div class="hero-buttons">
            <a href="{{ route('login') }}" class="btn-primary">Iniciar Sesión en el Sistema</a>
    ...
    <section class="cta">
        ...
        <a href="{{ route('login') }}" class="btn-primary" style="background: white; color: #d20000;">Acceder al Sistema</a>
    </section>
